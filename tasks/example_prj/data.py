...
'''
Функція load_data читає дані з файлу та повертає список рядків. 

Функція clean_data виконує очищення даних та перетворює рядки в числа і відкидає порожні рядки.
'''
